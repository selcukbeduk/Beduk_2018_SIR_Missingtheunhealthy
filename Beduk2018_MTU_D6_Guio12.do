...
Purpose: Analysing mismatch of Guio, Gordon, Marlier 2012 with Unmet Health Care Need due to Inadequate resources indicator

Inputs: SILC09_GGM12 (from MD_D3_MDindices, using EU SILC 2009; core household, register and personal files and the deprivation module)
...
tab country MDstat [aw=RB050], nofreq row
