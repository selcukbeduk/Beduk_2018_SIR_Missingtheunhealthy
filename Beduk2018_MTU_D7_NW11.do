...
Purpose: Analysing mismatch of Nolan and Whelan 2011 with Unmet Health Care Need due to Inadequate resources indicator
...
// MISMATCH 
tab CNW I_unmet
tab CNW I_unmet [aw=RB050], nofreq cell 
tab CNW I_unmet [aw=RB050], nofreq col

tab CMDNW I_unmet
tab CMDNW I_unmet [aw=RB050], nofreq cell 
tab CMDNW I_unmet [aw=RB050], nofreq col

tab CSMDNW I_unmet
tab CSMDNW I_unmet [aw=RB050], nofreq cell 
tab CSMDNW I_unmet [aw=RB050], nofreq col
